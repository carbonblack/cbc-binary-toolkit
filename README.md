...
**Note: Linux users will need to have the python developer package installed in order to compile yara-python. If there are compile errors make sure to be on the latest gcc compiler**
