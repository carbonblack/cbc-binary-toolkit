...
BASIC_INPUT_ANSWER_PATH = 'input_fixtures/basic/csv_answer'
LARGE_INPUT_ANSWER_PATH = 'input_fixtures/large/csv_answer'
BASIC_JSON_ANSWER_PATH = 'input_fixtures/basic/json_answer'
LARGE_JSON_ANSWER_PATH = 'input_fixtures/large/json_answer'


BASIC_INPUT_CSV_WRONG_HASHLEN = 'input_fixtures/basic/csv_input_wrong_hashlength'
BASIC_JSON_MALFORMED_FILE = 'input_fixtures/basic/json_input_malformed'
BASIC_JSON_WRONG_HASHLEN = 'input_fixtures/basic/json_input_wrong_hashlength'
